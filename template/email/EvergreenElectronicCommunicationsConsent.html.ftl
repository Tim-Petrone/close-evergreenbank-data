...
<body class="background">
    ...
    <div class="contentBody">
        ...
        <p>
            We received your home improvement loan application with ${dealerName}. For us to process the loan request quickly and conveniently, please authorize us to communicate electronically with you.
        </p>
