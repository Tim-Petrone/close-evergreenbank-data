...
<body class="background">
    ...
    <div class="contentBody">
        ...
        <p>
            Your Closing Disclosure has been updated to reflect the exact Disbursement Date regarding your loan. You should receive your first loan statement within 2-3 weeks.
        </p>
        <p>
            You may access your Closing Disclosure using the link below. 
        </p>
        <a href="${detailLinkPath}?orderId=${orderId}" class="button">Access Forms</a>
    </div>
