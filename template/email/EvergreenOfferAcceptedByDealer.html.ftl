...
<body class="background">
    ...
    <div class="contentBody">
        ...
        <#if !counterOffer && isSecured>
            <p>Thank you! A title report is now being ordered. We will update you once the report is received to confirm ownership and that one mortgage lien exists.</p>
        </#if>

        <#if counterOffer && !isSecured>
            <p>Thank you! This unsecured loan should be approved shortly using the counter-offered terms.<p>
        </#if>

        <#if counterOffer && isSecured>
            <p> Thank you for accepting the counter-offer! A title report is now being ordered. We will update you once the report is received to confirm ownership and that one mortgage lien exists.</p>
        </#if>
    </div>
